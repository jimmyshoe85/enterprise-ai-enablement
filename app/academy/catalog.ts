...
export const academyCourses: AcademyCourse[] = [
  {
    ...
    description: "A plain-English introduction to working with AI at Miller. Learn what AI does well, where it gets things wrong, how to use approved tools responsibly, and how to recognize a useful place to begin. This is a starting point, not a test and not a prerequisite for bringing an idea forward.",
    outcomes: [
    ...
    leaveBehind: "A practical readiness map and a clear next step",
    agenda: [
      {
        ...
        rows: [
          ...
          { title: "The Miller AI ecosystem", description: "The approved tools, the policy, and the support available when you want to move." },
    ...
    leaveWith: [
      ...
      { title: "Policy confidence", description: "A plain understanding of the responsible-use boundaries that apply to everyday work." },
  ...
  },
  {
    id: "itw-way",
    audience: "Leaders",
    framework: "CBI · 80/20 · DECENTRALIZATION",
    title: "Set AI Strategy the ITW Way",
    subtitle: "Build capability broadly, keep ownership close to the work, and invest in repeated value.",
    for: "Business and platform leaders",
    format: "45 minutes + Q&A · Keynote",
    description: "Miller's AI strategy begins with people and business units solving the problems they understand best. Their ideas and experiments become signals. When the same need appears across the organization, the enterprise can provide shared support and use 80/20 discipline to invest in the few opportunities with broader value.",
    outcomes: [
      "Treat employees and business units as sources of insight and opportunity",
      "Keep ownership and experimentation close to the work",
      "Recognize repeated needs as signals for shared enterprise support",
      "Apply 80/20 to the investments that truly require broader scale",
    ],
    leaveBehind: "An ITW-aligned enterprise AI strategy lens",
    agenda: [
      {
        heading: "The talk",
        rows: [
          { title: "Start with the business", description: "Listen to the problems employees and business units are already trying to solve." },
          { title: "Keep action decentralized", description: "Let local owners build and learn without forcing every idea into a central program." },
          { title: "Recognize the pattern", description: "See when unrelated efforts reveal the same shared need." },
          { title: "Fund the vital few", description: "Use 80/20 discipline when broader infrastructure or enterprise investment is justified." },
          { title: "Share support, not ownership", description: "The enterprise provides the ecosystem while business units remain accountable for their work." },
        ],
      },
    ],
    leaveWith: [
      { title: "A bottom-up signal lens", description: "A way to learn from local pain points, ideas, and experiments." },
      { title: "An 80/20 investment view", description: "A clear distinction between what should stay local and what deserves shared investment." },
      { title: "A decentralization principle", description: "Business units own the work; the enterprise makes responsible action easier." },
    ],
  },
  {
    id: "investment",
